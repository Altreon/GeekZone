...
if(isset($_GET['suppCompteBoutique']) && !empty($_GET['suppCompte'])){
	suppTableauUser($_GET['suppBoutique'], $base, $hote, $utilisateur, $mdp);
}

//creaTableauBoutique("id", $base, $hote, $utilisateur, $mdp);

if ( isset($_GET['editCompteBoutique']) && !empty($_GET['editCompte']) ) {
	editTableauUser($_GET['editBoutique'], $base, $hote, $utilisateur, $mdp); //Affiche le formulaire d'édition d'une personne
}else{
